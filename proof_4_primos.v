...
(* On vérifie qu'il y a bien 2 triggers de Zimone sur la stack au passage à l'endstep
   Pour avoir les deux triggers on doit remplir certaines conditions : 
    - Il y a un nombre premier de land
    - Une land est entrée en jeu ce tour ci
    - Si on veut deux triggers, il faut exactement déclencher un trigger additionnel
*)
